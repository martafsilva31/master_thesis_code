...
if __name__ == "__main__":
    ...
    list_bench_5 = remove_element(list_benchmarks,'sm') 
    list_bench_5 = remove_element(list_benchmarks,'bench_1')
    list_bench_5 = remove_element(list_benchmarks,'bench_2')
    list_bench_5 = remove_element(list_benchmarks,'bench_3')
    list_bench_5 = remove_element(list_benchmarks,'bench_4')

    print(os.listdir(f'{args.main_dir}/signal_samples/{args.sample}_smeftsim_SM/Events'))
   ...
   # for run in os.listdir(f'{args.main_dir}/signal_samples/{args.sample}_smeftsim_SM/Events'):
    ...
    miner.reweight_existing_sample(
        ...
        run_name='run_27',
        sample_benchmark='sm',
        reweight_benchmarks=  list_bench_5, 
        param_card_template_file=param_card_template_file,
        log_directory=f'{args.main_dir}/logs/{args.sample}_smeftsim_SM_reweight/run_27',
    )