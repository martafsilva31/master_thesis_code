...
def run_delphes_analysis_SLURM(sample_folder, main_dir, do_delphes, delphes_card='cards/delphes_card_ATLAS.tcl'):
    ...
    runs = sorted(os.listdir(sample_folder))[:10]   
    for run in runs:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--delphes_card',help='path to Delphes card',default='')
    ...
    if args.do_bsm:
        sample = 'wph_mu'
        bench = "neg_chwtil" #change the benchmark name in the delphes_analysis.py file
