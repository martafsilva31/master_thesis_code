...
def alices_training(config):
  ...
  result = ensemble.train_all(method='alices',
    theta=f"{config['main_dir']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/theta0_train_ratio_{config['sample_name']}_0.npy",
    x=f"{config['main_dir']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/x_train_ratio_{config['sample_name']}_0.npy",
    y=f"{config['main_dir']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/y_train_ratio_{config['sample_name']}_0.npy" ,
    r_xz=f"{config['main_dir']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/r_xz_train_ratio_{config['sample_name']}_0.npy" ,
    t_xz=f"{config['main_dir']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/t_xz_train_ratio_{config['sample_name']}_0.npy" ,
...
if __name__ == "__main__":
    ...
    logging.info(f'observable set: ; sample type: {config["sample_name"]}')
