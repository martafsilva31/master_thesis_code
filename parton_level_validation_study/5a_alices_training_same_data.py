...
def alices_training(config):
  ...
  model_name = f"alices_hidden_{config['alices']['training']['n_hidden']}_{config['alices']['training']['activation']}_alpha_{config['alices']['training']['alpha']}_epochs_{config['alices']['training']['n_epochs']}_bs_{config['alices']['training']['batch_size']}_same_data"
  ...
  result = ensemble.train_all(method='alices',
    theta=f"{config['main_dir']}/{config['observable_set']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/theta0_train_ratio_{config['sample_name']}_0.npy",
    x=f"{config['main_dir']}/{config['observable_set']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/x_train_ratio_{config['sample_name']}_0.npy",
    y=f"{config['main_dir']}/{config['observable_set']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/y_train_ratio_{config['sample_name']}_0.npy" ,
    r_xz=f"{config['main_dir']}/{config['observable_set']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/r_xz_train_ratio_{config['sample_name']}_0.npy" ,
    t_xz=f"{config['main_dir']}/{config['observable_set']}/training_samples/alices_{config['alices']['training']['training_samples_name']}/t_xz_train_ratio_{config['sample_name']}_0.npy" ,
