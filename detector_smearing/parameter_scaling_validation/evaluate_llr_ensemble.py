...
model_path = "/lstore/titan/martafsilva/master_thesis/master_thesis_output/detector_smearing_output/met/models/gaussian_prior_0_0.4/kinematic_only/alices_hidden_[50]_relu_alpha_5_epochs_50_bs_128_thetas_with_scaling/alices_ensemble_wh_signalOnly_SMonly_noSysts_lhe"
...
plt.plot(theta_each,-2*np.average(log_r_hat,axis=1, weights = weights), ls='-', label = r"$\hat{r}(x|\theta)$ (ALICES)")
plt.xlabel(r'$\theta$')
plt.ylabel('Log Likelihood Ratio')
plt.legend()

plt.savefig("llr_ensemble_gaussian_prior_0_0.4_kinematic_only_alices_hidden_[50]_relu_alpha_5_epochs_50_bs_128_with_parameter_scaling.pdf")
