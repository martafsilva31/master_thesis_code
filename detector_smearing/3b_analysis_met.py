...
def choose_observables(observable_set):
    ...
    if observable_set == 'met':   
        ...
        raise ValueError(f"Unknown observable_set: {observable_set}. Please choose 'met' as the observable set.")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Parton-level analysis of signal and background events using as observables only "physical" degrees of freedom (MET, mTW, q_l, etc.). Includes also the computation of the pZ of the neutrino and several angular observables',formatter_class=argparse.ArgumentDefaultsHelpFormatter)
